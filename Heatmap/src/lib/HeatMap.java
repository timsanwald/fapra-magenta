...
public class HeatMap {
     ...
     */
    public HeatMap(final List<Point> points, int width, int height) {
        initMap(points, width, height);
    }
     ...
     *            list of points
     */
    private void initMap(final List<Point> points, int width, int height) {
